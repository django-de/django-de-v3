...
from django_de.apps.wakawaka.forms import WikiPageForm, DeleteWikiPageForm
...
def page(request, slug, rev_id=None, fallback_template_name='wakawaka/page_fallback.html', extra_context={}):
    '''
    ...
    template_name = page.template or fallback_template_name
